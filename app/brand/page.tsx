  ...
  return (
    <div className={`bk ${display.variable} ${body.variable} ${mono.variable}`}>
      ...
      <div className="wrap">
        ...
        <div className="sw"><div className="chip" style={{background:"#121719"}} /><div><b>tile</b><span className="dm">#121719</span><span className="mu">the dark ground every mark sits on</span></div></div>
