    ...
    <div className={`bk ${display.variable} ${body.variable} ${mono.variable}`}>
      ...
      <div className="wrap">
        ...
        <article className="mark picked">
          ...
          <div>
            <h3>The Dissolving Card<span className="badge">picked</span></h3>
        ...
        <section>
          ...
          <hr className="rule" />
        <div className="sw"><div className="chip" style={{background:"#0B0B10"}} /><div><b>ink</b><span className="dm">#0B0B10</span><span className="mu">page ground</span></div></div>
        ...
        <div className="sw"><div className="chip" style={{background:"#5EEAD4"}} /><div><b>mint 300</b><span className="dm">#5EEAD4</span><span className="mu">the single accent — links, ticks, domain</span></div></div>
        <div className="sw"><div className="chip" style={{background:"#8B8B99"}} /><div><b>muted</b><span className="dm">#8B8B99</span><span className="mu">secondary type</span></div></div>
        </section>
        ...
        <section>
          ...
          <table>
            ...
            <tr><td className="dm">fakewallet.fun</td><td><span className="pill open">available</span></td><td className="mu">the pick — confirmed unregistered</td></tr>
        ...
        <section>
          ...
          <ol className="steps">
            ...
            <li>Move the files out of <span className="dm">/public/brand/</span> into <span className="dm">/public/</span>,
            replacing the Phantom ghost icons sitting there now.</li>
            <li>Replace <span className="dm">title: &quot;Phantom&quot;</span> in <span className="dm">app/layout.tsx</span> —
            right now the tab, the bookmarks and every search result all say Phantom.</li>
          </ol>
